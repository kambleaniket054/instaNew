...
StreamController<bool> statecontroller = StreamController.broadcast();
  ...
  var bloc =  bottomNavigationBloc();
    ...
    bottomNavigationBar:BlocConsumer<bottomNavigationBloc,bottomnavigationstate>(
        bloc: bloc,
        builder: (context, state) {
          var tab = state as navigationTabindex;
        ...
        BottomNavigationBarItem(icon: Icon(Icons.person), label: 'Profile'),
          ...
          onTap: (value){
            // context.read<bottomNavigationBloc>().add(changebottomscreen(value));
            bloc.add(changebottomscreen(value));
 ...
 Widget _buildScreenTransition(Widget screen) {
